...
public class MainActivityEspressoTest {
    ...
    public void testCadaBoton() {
        ...
        Espresso.closeSoftKeyboard();
        Espresso.onView(ViewMatchers.withId(R.id.button_ncalculo)).perform(ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.numero1)).perform(ViewActions.clearText());
        Espresso.onView(ViewMatchers.withId(R.id.numero2)).perform(ViewActions.clearText());
        Espresso.onView(ViewMatchers.withId(R.id.numero1)).perform(ViewActions.typeText("50"));
        Espresso.onView(ViewMatchers.withId(R.id.numero2)).perform(ViewActions.typeText("30"));
        Espresso.closeSoftKeyboard();
        Espresso.onView(ViewMatchers.withId(R.id.button_multiplicar)).perform(ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.resultado))
                .check(ViewAssertions.matches(ViewMatchers.withText("Multiplicación: 1500")));
